...
class RadiusFinder(object):
  ...
  def process_image(self, img_path, binary_threshold_min=40):
    if img_path in self.cache:
    ...
    self.processed_img = self._preprocess_image(img_path, (binary_threshold_min, 100))
...
if __name__ == '__main__':
  rf = RadiusFinder()
  # rf.get_processed_image("/home/hjortur/workspace/vesicle_analyzer/tiff")
  asdf = rf.get_processed_image(
    '/home/hjortur/workspace/vesicle_analyzer/tiff/200xg_Mark_and_Find_Position008_t17_ch04.tif', 30)
  # print(type(asdf))
